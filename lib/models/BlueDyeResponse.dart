...
class BlueDyeResponse extends amplify_core.Model {
  ...
  factory BlueDyeResponse({String? id, required int stamp, required int finishedEating, List<BlueDyeResponseLog>? logs, required String subUserId}) {
  ...
  BlueDyeResponse copyWith({int? stamp, int? finishedEating, List<BlueDyeResponseLog>? logs, String? subUserId}) {
    return BlueDyeResponse._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'stamp': _stamp, 'finishedEating': _finishedEating, 'logs': _logs?.map((BlueDyeResponseLog? e) => e?.toJson()).toList(), 'subUserId': _subUserId, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
