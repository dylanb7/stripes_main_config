...
class BlueDyeTest extends amplify_core.Model {
  ...
  factory BlueDyeTest({String? id, required int stamp, int? finishedEating, List<BlueDyeTestLog>? logs, required SubUser subUser}) {
  ...
  BlueDyeTest copyWith({int? stamp, int? finishedEating, List<BlueDyeTestLog>? logs, SubUser? subUser}) {
    return BlueDyeTest._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'stamp': _stamp, 'finishedEating': _finishedEating, 'logs': _logs?.map((BlueDyeTestLog? e) => e?.toJson()).toList(), 'subUser': _subUser?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
