...
class DetailResponse extends amplify_core.Model {
  ...
  factory DetailResponse({String? id, required int stamp, String? type, String? description, List<Response>? responses, required String subUserId}) {
  ...
  DetailResponse copyWith({int? stamp, String? type, String? description, List<Response>? responses, String? subUserId}) {
    return DetailResponse._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'stamp': _stamp, 'type': _type, 'description': _description, 'responses': _responses?.map((Response? e) => e?.toJson()).toList(), 'subUserId': _subUserId, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
