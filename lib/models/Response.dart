...
class Response extends amplify_core.Model {
  ...
  factory Response({String? id, required int stamp, required String type, required String qid, String? textResponse, int? selected, int? numeric, List<int>? all_selected, required String subUserId, DetailResponse? detailResponse}) {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("stamp=" + (_stamp != null ? _stamp!.toString() : "null") + ", ");
  ...
  Response copyWith({int? stamp, String? type, String? qid, String? textResponse, int? selected, int? numeric, List<int>? all_selected, String? subUserId, DetailResponse? detailResponse}) {
    return Response._internal(
      id: id,
  ...
  Response.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _stamp = (json['stamp'] as num?)?.toInt(),
      _type = json['type'],
      _qid = json['qid'],
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'stamp': _stamp, 'type': _type, 'qid': _qid, 'textResponse': _textResponse, 'selected': _selected, 'numeric': _numeric, 'all_selected': _all_selected, 'subUserId': _subUserId, 'detailResponse': _detailResponse?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
